...
/* CONSTANT DEFINITIONS */
	...
	define( 'AFFILIATES_NONCES_ARRAY',
		wp_json_encode(array(
			'adminnonce1' => 'wpbooklist_affiliates_save_license_key_action_callback',
...
/* FUNCTIONS FOUND IN CLASS-WPBOOKLIST-GENERAL-FUNCTIONS.PHP THAT APPLY PLUGIN-WIDE */
	...
	add_action( 'plugin_action_links_' . plugin_basename( __FILE__ ), array( $affiliates_general_functions, 'wpbooklist_affiliates_pluginspage_license_entry' ) );
	...
	add_filter( 'option_active_plugins', array( $affiliates_general_functions, 'wpbooklist_affiliates_verify_license' ) );
...
/* FUNCTIONS FOUND IN CLASS-WPBOOKLIST-AJAX-FUNCTIONS.PHP THAT APPLY PLUGIN-WIDE */
	...
	add_action( 'wp_ajax_wpbooklist_affiliates_save_license_key_action', array( $affiliates_ajax_functions, 'wpbooklist_affiliates_save_license_key_action_callback' ) );
