...
jQuery( document ).ready( function( $ ) {
	...
	function // Function that actually saves the Affiliate IDs...
	wpbooklistAffiliatesSaveIds() {
	...
	function wpbooklistAffiliatesPluginPageDashboardSaveKey() {
		...
		$( '#wpbooklist-extension-licence-key-dashboard-form-affiliates' ).on( 'submit', function() {

			var license = $( this ).find( '.wpbooklist-extension-licence-key-dashboard-input' ).val();

			// Make Ajax call to get display options.
			var data = {
				'action': 'wpbooklist_affiliates_save_license_key_action',
		...
		$( '#wpbooklist-extension-licence-key-plugins-page-button-affiliates' ).on( 'click', function() {
